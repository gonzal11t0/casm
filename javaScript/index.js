...
var card1 = createCard("entradas socios", "Los dias Lunes 23 y martes 24 solamente esta habilitada la venta de entradas para socios, los socio pleno cancha retira entrada con cuota paga y carnet fisico/digital, el valor de entrada platea $5000");
var card2 = createCard("Entradas no socios", "Apartir del miercoles 25 venta de entrada para no socios, platea $7000, popular $3000, jubilados, damas $2000, menores $1000");
var card3 = createCard("Colocalcion de tubulares", "Durante el dia sabado `La eterna plazoleta` termino la colocacion de las tubulares ubicadas atras del arco y al costado de la popular y la platea, se espera una capacidad de para 13.000 personas.");
var card4 = createCard("Personas con discapacidad", "Toda persona con discapacidad que quiera presenciar el próximo partido, deberá enviar un mail con sus datos y del acompañante a: c.a.sanmiguelcomplejoolimpico@gmail.com, Se recibirán las solicitudes hasta el día jueves 18 hs. Las entradas se retiran el día viernes de 14 a 21 hs , en el Complejo Olímpico Malvinas Argentinas.");
...
desarrolladorLink.href = "https://www.linkedin.com/in/gonzalo-lazarte-desarrollador-web/";
